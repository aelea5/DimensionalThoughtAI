...
root = tk.Tk()
root.title("AI Thought Navigator")

tk.Label(root, text="Enter a thought:").pack()
thought_entry = tk.Entry(root)
thought_entry.pack()

tk.Label(root, text="Select a context:").pack()
context_var = tk.StringVar(value="default")
tk.Radiobutton(root, text="Default", variable=context_var, value="default").pack()
tk.Radiobutton(root, text="Danger", variable=context_var, value="danger").pack()
tk.Radiobutton(root, text="Comfort", variable=context_var, value="comfort").pack()

tk.Button(root, text="Navigate Thoughts", command=submit_thought).pack()
